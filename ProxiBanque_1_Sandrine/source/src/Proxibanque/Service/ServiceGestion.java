 ...
 * Permets de réaliser toutes les problématiques de gestions de comptes et des clients (création, modifications etc.).
 * ces méthodes sont utilisés par le conseillé via le lanceur.
 * @author Sandrine
 * @version 0.1
 *
 */
public interface ServiceGestion {
	//Outils métiers du service gestion
	/**
	 * sauvegarde le client.
	 * @param c
	 * Instance Client à créer et à sauvegarder
	 */
	public void creerClient(Client c);
	/**
	 * cette méthode appelle l'interface DAO
	...
	/**
	 * Attribue un compte épargne à un client
	 * @param id 
	 * identifiant du client
	 * @param c
	 * compte épargne à attribuer au client avec l'identifiant id.
	 */
	 ...
	 * @param carte
	 * carte à attribuer au client id
	 */
	 ...
	 * @param id
	 * identifiant du client à supprimer (fait appel aux méthode de suppression de la carte et des comptes pour respecter la spécification).
	 */
	public void supprimerClient(Integer id);
	
	//outils de developpement
	/**Retourne un client spécifique à partir de son id (Outil pour faciliter le développement)
	 * @param id
	 * identifiant du client à retourner
	 * @return
	 * client à retourner
	 */
	public  Client retournClient(Integer id);
	/**renvoie la liste globale des clients (outils pour faciliter le developpement).
	 * @return
	 * client à retourner
	 */
